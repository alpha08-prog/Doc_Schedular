...
const Prescriptions: React.FC<Props> = ({ patientId }) => {
  ...
  if (loading) {
    return <div className="py-8 text-center text-gray-500">Loading prescriptions...</div>;
  }
  ...
  if (prescriptions.length === 0) {
    return <div className="py-8 text-center text-gray-500">No prescriptions found.</div>;
  }
          ...
          <div className="flex items-center justify-between mb-2">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Prescribed by: {rx.doctorId} | Date:{" "}
