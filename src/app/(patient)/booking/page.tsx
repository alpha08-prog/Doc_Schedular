...
import EmptyAppointments from "@/app/components/appointment/EmptyAppointments";
...
export default function BookingPage() {
  ...
  const tabData = [
    ...
    {
      label: "Completed",
      count: mockAppointments.completed.length,
      data: mockAppointments.completed,
    },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 pb-24">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 pt-8">
        ...
        {/* Quick Actions */}
        <div
          className={`grid grid-cols-3 gap-4 mb-6 ${mounted ? "animate-slide-up" : "opacity-0"}`}
        ...
        {/* Tabs */}
        <div
          className={`bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden ${mounted ? "animate-scale-in" : "opacity-0"}`}
